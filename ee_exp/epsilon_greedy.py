...
class EpslionGreedy(object):
    """
    Wrmax class
    """

    def  __init__(self, candidates, env, epsilon, dropout_prob=1.0, batch_size=64, replay_memory_size=100000):
    ...
    def choose_samples(self, context_feature):
        ...
        if random.random() > self._epsilon:
          ...
          idx = random.randint(0, self._candidate_number-1)
          print >> sys.stderr, 'random: ', idx
          return idx
